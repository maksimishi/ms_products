...
из интерфейса приложения. На странице таблицы вверху есть кнопка «Проверить доп.
поля». Нажмите её, чтобы увидеть список существующих атрибутов и создать
недостающие поля одним кликом.
...
- **Вид размера** - значение пользовательского поля
